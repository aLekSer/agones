...
func main() {
	...
	clientCnt := flag.Int("clients", 120, "The number of concurrent clients")
...
func allocate(framework *e2eframework.Framework, numOfClients int, fleetName string) {
	gsa := &allocationv1.GameServerAllocation{
		...
		Spec: allocationv1.GameServerAllocationSpec{
			Required: metav1.LabelSelector{MatchLabels: map[string]string{agonesv1.FleetNameLabel: "simple-udp-packed"}},
