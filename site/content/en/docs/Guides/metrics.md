...
Default metrics exporter is Prometheus. In order to change it to Stackdriver update following helm parameters in [values file](../install/helm/agones/values.yaml):
```
agones:
  metrics:
